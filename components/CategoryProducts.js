...
export default function CategoryProducts({ category }) {
  ...
  return (
    <div className="max-w-[90rem] mx-auto px-4 md:px-8 py-8 mt-8">
      ...
      <div className="flex justify-center flex-wrap gap-3 md:gap-4 lg:gap-5">
        {products.map((product) => (
          <Link
            ...
            "
          >
            <div className="relative aspect-[4/4.5] overflow-hidden"> {/* ↓ moins haut */}
              <img
                src={product.image}
                alt={product.name}
      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center mt-8 space-x-3">
          ...
          <span className="text-gray-700 font-medium text-sm md:text-base">{page + 1} / {totalPages}</span>
          <button
