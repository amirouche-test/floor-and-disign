...
export default function ClientProduitVoir({ slug }) {
  ...
  return (
    <>
      <div className=" mb-20 max-w-7xl mx-auto px-4 font-sans text-gray-800 text-base">
        ...
        <div className="flex justify-between items-center py-4 mb-8 border-b border-gray-200">
          ...
          <p className="text-2xl font-semibold italic tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-blue-400 to-blue-600">
          ...
          <div className="flex gap-8 mt-10 flex-wrap lg:flex-nowrap">
            ...
            <div className="flex-1 flex flex-col space-y-6">
              ...
              <div className="flex gap-2">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="h-9 bg-gray-200 rounded-full w-20 animate-pulse"></div>
                ))}
              </div>
